...
#Sessionmaker crea las seciones par ainteracctuar con la base de datos
...
# Este archivo prepara todo lo necesario para conectar y trabajar con la base de datos usando SQLAlchemy en el proyect
